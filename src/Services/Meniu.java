...
public class Meniu {
    ...
    public void main(Vector<Locatie> loc, Vector<Persoana> pers, Vector<Angajat> ang, Vector<Categorie> cat, Vector<Produs> prod, Vector<Depozit> dep, Vector<Furnizor> furn, Vector<Magazin> mag) throws IOException, SQLException, InterruptedException {
        ...
        System.out.println("Cum doresti sa lucrezi? normal | csv | mysql?");
        ...
        if(modLucru.equals("normal")) {
            ...
            while (opt >= 0 & opt < 10) {
                ...
                switch (opt) {
                    ...
                    case 9: { // Cand vreau sa adaug date.
                        String clasa;
                        System.out.println("Pe care dintre clase vrei sa lucrezi?");
                        System.out.println("Locatie | Furnizor | Depozit | Magazin | Persoane | Angajati | Categorii | Produse");
                        clasa = scanner.next();
        ...
        } else if (modLucru.equals("mysql")) {
            System.out.println("1. Citire normala");
            ...
            System.out.println("\n13. Calculare cantitate totala de produse in stoc dintr-un depozit");
            System.out.println("\n14. Afisare stocurile sortate ale unui depozit");
            System.out.println("\n15. Iesire");
            int opt = 0;
            while (opt >= 0 & opt < 16){
                System.out.println("Ce doresti sa faci?");
                ...
                switch (opt) {
                    case 1: { // Cazul 1 adica cand vreau sa adaug date.
                        ...
                        SimpleDateFormat data = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
                        String timp = data.format(timestamp);
                        Servicii.creareAudit("Citire Normala", timp);
                        break;
                    }
                    case 2: {
                        Servicii.citireCsv(pers, cat, loc, prod);
                        ...
                        SimpleDateFormat data = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
                        String timp = data.format(timestamp);
                        Servicii.creareAudit("Preluare date din Fisierele CSV", timp);
                        break;
                    }
                    case 3: {
                        Servicii.citireBd(DbConnection.getConnection(), pers, cat, loc, prod);
                        Date timestamp = new Date();
                        SimpleDateFormat data = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
                        String timp = data.format(timestamp);
                        Servicii.creareAudit("Citire Date din BD MySql", timp);
                        break;
                    }
                    case 4: { // Cazul 2 adica atunci cand vreau sa afisez datele
                        String clasa;
                        System.out.println("Pe care dintre clase vrei sa lucrezi?");
                        System.out.println("Locatie | Furnizor | Depozit | Magazin | Persoane | Angajati | Categorii | Produse");
                        clasa = scanner.next();
                    ...
                    case 5: {
                        Servicii.inserareBd(DbConnection.getConnection(), pers, cat, loc, prod);
                        Date timestamp = new Date();
                        SimpleDateFormat data = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
                        String timp = data.format(timestamp);
                        Servicii.creareAudit("Inserare Date in BD MySql", timp);
                        break;
                    }
                    case 6: { // Cazul 3 in care doresc sa modific informatiile.
                        String clasa;
                        System.out.println("Pe care dintre clase vrei sa lucrezi?");
                        System.out.println("Locatie | Furnizor | Depozit | Magazin | Persoane | Angajati | Categorii | Produse");
                        clasa = scanner.next();
